 ...
 * It will be called ProductCustomergroupMappingDefinition and is responsible for connecting both definitions. 
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            (new FkField(
                ...
                'customerGroupId',
                /** the property name in the definition class */
                CustomerGroupDefinition::class
                /** respective definition class */
            ...
            new ManyToOneAssociationField(
                'customergroups',
                /** name of the property in your entity, which should contain the entries */
                'customer_group_id',
                /** name of the column in the database */
                CustomerGroupDefinition::class,
                /** respective definition class */
